...
class Batch extends CI_Controller
{
	...
	function __construct()
	{
		parent::__construct();
		// check_not_login();
		$this->load->model('M_qa/M_batch');
	}

	public function index()
	{
		// $data['row'] = $this->customer_m->get();
		$data['result'] = $this->M_batch->get()->result_array();
		$this->template->load('template', 'content/qa/batch_data', $data);
		// print_r($data);
	...
	public function pdf_page_print()
    {
        ...
        $data['detail'] = $this->M_batch->get($name);
        $data['name'] = $name;

        $d = $this->load->view('laporan/qa/page_print_batch', $data, TRUE);
