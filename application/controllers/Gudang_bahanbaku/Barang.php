...
class Barang extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->load('template', 'content/gudang_bahanbaku/barang/barang_data', $data);
		// print_r($data);
	...
	public function add()
	{
		...
		if ($respon) {
			header('location:' . base_url('gudang_bahanbaku/Barang') . '?alert=success&msg=Selamat anda berhasil menambah Barang');
		} else {
			header('location:' . base_url('gudang_bahanbaku/Barang') . '?alert=error&msg=Maaf anda gagal menambah Barang');
		}
	}
	public function update()
	{
		...
		// echo $respon;
		if ($respon) {
			header('location:' . base_url('gudang_bahanbaku/Barang') . '?alert=success&msg=Selamat anda berhasil meng-update Barang');
		} else {
			header('location:' . base_url('gudang_bahanbaku/Barang') . '?alert=error&msg=Maaf anda gagal meng-update Barang');
		}
	}
	public function delete($id_barang)
	{
		...
		if ($respon) {
			header('location:' . base_url('gudang_bahanbaku/Barang') . '?alert=success&msg=Selamat anda berhasil menghapus Barang');
		} else {
			header('location:' . base_url('gudang_bahanbaku/Barang') . '?alert=error&msg=Maaf anda gagal menghapus Barang');
		}
	}
