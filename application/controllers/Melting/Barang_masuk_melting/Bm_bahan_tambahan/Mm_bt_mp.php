...
class Mm_bt_mp extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'content/melting/barang_masuk_melting/masuk_melting_bahan_tambahan/mm_methyl_paraben', $data);
        // print_r($data); 
