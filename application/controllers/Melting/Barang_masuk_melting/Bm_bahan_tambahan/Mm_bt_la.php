...
class Mm_bt_la extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'content/melting/barang_masuk_melting/masuk_melting_bahan_tambahan/mm_lecithin_adlec', $data);
        // print_r($data); 
