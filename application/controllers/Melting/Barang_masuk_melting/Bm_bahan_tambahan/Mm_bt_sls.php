...
class Mm_bt_sls extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'content/melting/barang_masuk_melting/masuk_melting_bahan_tambahan/mm_sodium_launil_sulfat', $data);
        // print_r($data); 
