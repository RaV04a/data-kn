            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('gudang_bahanbaku/Laporan_barang_masuk') ?>">Barang Masuk</a></li>
                </ul>
              </div>
            </div>
          </div>
                  ...
                  <div class="card-header">
                    ...
                    <div class="float-right">
                      <div class="input-group">
                        ...
                        <div class="btn-group">
                          <a href="<?= base_url() ?>gudang_bahanbaku/Laporan_barang_masuk" style="width: 40px;" class="btn btn-warning" id="export" type="button"><i class="feather icon-refresh-ccw"></i></a>
                        </div>
                      </div>
                    </div> <br> <br>
                  </div>
  ...
  $(document).ready(function() {
    $('#lihat').click(function() {
      ...
      if (filter_tgl == '' && filter_tgl2 != '') {
        ...
        window.location = "<?= base_url() ?>gudang_bahanbaku/Laporan_barang_masuk?alert=warning&msg=form periode harus diisi";
      } else {
        ...
        window.location = "<?= base_url() ?>gudang_bahanbaku/Laporan_barang_masuk/index?" + query.toString()
    ...
    $('#export').click(function() {
      ...
      if (filter_tgl == '' && filter_tgl2 != '') {
        ...
        var url = "<?= base_url() ?>gudang_bahanbaku/Laporan_barang_masuk/pdf_laporan_barang_masuk";
