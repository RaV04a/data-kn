            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="javascript:">Master Gudang</a></li>
                  <li class="breadcrumb-item"><a href="<?= base_url('gudang_bahanbaku/Barang') ?>">Barang</a></li>
                </ul>
              </div>
            </div>
          </div>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <?php if ($level === "admin" || $level === "purchasing") { ?>
                                  ...
                                  <div class="btn-group" role="group">
                                    <a href="<?= base_url() ?>gudang_bahanbaku/Barang/delete/<?= $k['id_barang'] ?>" class="btn btn-danger btn-square text-light btn-sm" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>gudang_bahanbaku/Barang/add">
          ...
          <div class="row">
            ...
            <div id="form_gel" class="col-md-6" style="display: none">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="jenis_gel" name="jenis_gel" autocomplete="off">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
  ...
  <div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="post" action="<?= base_url() ?>gudang_bahanbaku/Barang/update">
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
