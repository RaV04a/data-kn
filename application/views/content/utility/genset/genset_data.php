                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('Utility/Genset') ?>">GENSET</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="float-right">
                                            <div class="input-group">
                                                ...
                                                <div class="btn-group">
                                                    <a href="<?= base_url() ?>Utility/Genset" style="width: 40px;" class="btn btn-warning" id="export" type="button"><i class="feather icon-refresh-ccw"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <td class="text-right">
                                        ...
                                        if ($level === "utility") { ?>
                                            <div class="card-header">
                                                <button type="button" class="btn btn-light btn-outline-dark float-right btn-sm" onClick="window.open(`<?= base_url() ?>Utility/Genset/pdf_page_print/`)">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if ($level == "admin") { ?>
                                                                    ...
                                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                                        <a href="<?= base_url() ?>Utility/Genset/delete/<?= $k['id_hmu'] ?>" class="btn btn-danger btn-square text-light btn-sm" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
    ...
    $(document).ready(function() {
        $('#lihat').click(function() {
            ...
            if (filter_tgl == '' && filter_tgl2 != '') {
                window.location = "<?= base_url() ?>Utility/Genset?alert=warning&msg=dari tanggal belum diisi";
                alert("dari tanggal belum diisi")
            } else if (filter_tgl != '' && filter_tgl2 == '') {
                window.location = "<?= base_url() ?>Utility/Genset?alert=warning&msg=sampai tanggal belum diisi";
            } else if (filter_tgl == '' && filter_tgl2 == '') {
                window.location = "<?= base_url() ?>Utility/Genset?alert=warning&msg=form periode harus diisi";
            } else {
                ...
                window.location = "<?= base_url() ?>Utility/Genset/index?" + query.toString();
            }
        })
        $('#export').click(function() {
            ...
            if (filter_tgl == '' && filter_tgl2 != '') {
                ...
                var url = "<?= base_url() ?>Utility/Genset/pdf_page_print";
                ...
                var url = "<?= base_url() ?>Utility/Genset/pdf_page_print?" + query.toString();
                window.open(url, 'pdf_page_print', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
            }
        })
    })
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah History Mesin GENSET</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?= base_url() ?>Utility/Genset/add">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " id="e-jenis_mesin" name="jenis_mesin" value="GENSET" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<div class="modal fade" id="detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail History Mesin GENSET</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit History Mesin GENSET</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="<?= base_url() ?>Utility/Genset/update">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
