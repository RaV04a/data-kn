            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="page-header-title">
                  <h5 class="m-b-10">Data Protap Printing</h5>
                </div>
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?= base_url('QA/Doc/Doc_printing/pri_protap') ?>">Protap</a></li>
                </ul>
              </div>
            </div>
          </div>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                <?php if ($level === "admin" || $level === "purchasing") { ?>
                                  ...
                                  <div class="btn-group" role="group">
                                    <a href="<?= base_url() ?>QA/Doc/Doc_printing/pri_protap/delete/<?= $k['id_doc_pri'] ?>" class="btn btn-danger btn-square text-light btn-sm" onclick="if (! confirm('Apakah Anda Yakin?')) { return false; }">
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?= base_url() ?>QA/Doc/Doc_printing/pri_protap/add">
        <div class="modal-body">
          <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="jenis_doc_pri">Jenis Document</label>
                <input type="text" class="form-control" id="jenis_doc_pri" name="jenis_doc_pri" value="Protap" disabled>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
...
<div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Detail Protap Printing</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Protap Printing</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" action="<?= base_url() ?>QA/Doc/Doc_printing/pri_protap/update">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
