...
<head>
    ...
    <title>Hasil Data Pemeriksaan Pelarut</title>
    <style type="text/css">
        body {
    ...
    <table style="width:80%;" id="hh">
        <?php foreach ($detail as $key) { ?>
            ...
            <tr>
                ...
                <td class="syarat">Cairan jernih tidak berwarna</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Aroma</td>
                <td class="hsl"><?= $key['aroma'] ?></td>
                <td class="syarat">Khas Ethanol/Butanol</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Berat Jenis</td>
                <td class="hsl"><?= $key['berat_jenis'] ?></td>
                <td class="syarat">0,8032 – 0,8130 (Etanol)</td>
            </tr>
            <tr>
                <td class="hsl"></td>
                <td class="namapmr"></td>
                <td class="hsl"></td>
                <td class="syarat">0,8010 – 0,8100 (Butanol)</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="ket-hsl" colspan="3">: Pelarut dapat digunakan</td>
            </tr>
        <?php } ?>
    </table>
