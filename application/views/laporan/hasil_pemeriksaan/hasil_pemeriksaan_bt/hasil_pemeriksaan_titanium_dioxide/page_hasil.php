...
<head>
    ...
    <title>Hasil Data Pemeriksaan Bahan Tambahan (Titanium Dioxide)</title>
    <style type="text/css">
        body {
    ...
    <table style="width:80%;" id="hh">
        <?php foreach ($detail as $key) { ?>
            ...
            <tr>
                ...
                <td class="syarat">Serbuk amorf, warna putih, tidak berbau, tidak berasa</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
            ...
            <tr>
                <td class="hsl"></td>
                <td class="namapmr">Dalam H2 SO4 P</td>
                <td class="hsl"><?= $key['kel_h2so4p'] ?></td>
                <td class="syarat">Larut</td>
            </tr>
            <tr>
                <td class="hsl"></td>
                <td class="namapmr">Dalam HCI P</td>
                <td class="hsl"><?= $key['kel_hcip'] ?></td>
                <td class="syarat">Tidak Larut</td>
            </tr>
            <tr>
                <td class="hsl"></td>
                <td class="namapmr">Dalam Air</td>
                <td class="hsl"><?= $key['kel_air'] ?></td>
                <td class="syarat">Tidak Larut</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
            ...
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">0,5 gr TiO + H2SO4</td>
                <td class="hsl"><?= $key['tio2_h2so4'] ?></td>
                <td class="syarat">Terjadi warna merah jingga</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Susut Pengeringan</td>
                <td class="hsl"><?= $key['s_pengeringan'] ?></td>
                <td class="syarat">Tidak lebih dari 0.5 %</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
            ...
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Kesamaan terhadap pewarna</td>
                <td class="hsl"><?= $key['kes_pewarna'] ?></td>
