...
<head>
    ...
    <title>Hasil Data Pemeriksaan Bahan Tambahan (Natrium Benzoat)</title>
    <style type="text/css">
        body {
    ...
    <table style="width:80%;" id="hh">
        <?php foreach ($detail as $key) { ?>
            ...
            <tr>
                ...
                <td class="syarat">Hablur atau serbuk hablur, putih, tidak berbau, stabil di udara.</td>
            </tr>
            <tr>
                <td rowspan="2" class="hsl"><?= $no++ ?></td>
                <td rowspan="2" class="namapmr">Kelarutan</td>
                <td rowspan="2" class="hsl"><?= $key['kelarutan'] ?></td>
                <td class="syarat">Dalam air = 1 : 500</td>
            </tr>
            <tr>
                <td class="syarat">Dalam Ethanol 90 % = 1 : 3,5</td>
            </tr>
            <tr>
                <td rowspan="2" class="hsl"><?= $no++ ?></td>
                <td rowspan="2" class="namapmr">Identifikasi</td>
                <td rowspan="2" class="hsl"><?= $key['identifikasi'] ?></td>
                <td class="syarat">Natrium : warna kuning intensif dalam nyala api yang tidak berwarna</td>
            </tr>
            <tr>
                <td class="syarat">Benzoat : Dengan FeCl₃ terbentuk endapan merah muda kekuningan</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Kebasaan</td>
                <td class="hsl"><?= $key['kebasaan'] ?></td>
                <td class="syarat">Warna merah muda hilang pada penambahan 0.2 ml H₂SO₄ 0.1 N</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Penetepan Kadar</td>
                <td class="hsl"><?= $key['p_kadar'] ?></td>
                <td class="syarat">Antara 99,0% - 100,5</td>
            </tr>
            <tr>
