...
<head>
    ...
    <title>Hasil Data Pemeriksaan Bahan Tambahan (Candurin Silver Fine)</title>
    <style type="text/css">
        body {
    ...
    <table style="width:80%;" id="hh">
        <?php foreach ($detail as $key) { ?>
            ...
            <tr>
                ...
                <td class="syarat">Hablur putih kecoklatan</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
            ...
            <tr>
                ...
                <td class="syarat">6 - 11(larutan 10 % dalam air)</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
