...
<head>
    ...
    <title>Hasil Data Pemeriksaan Bahan Tambahan (Sodium Launil Sulfat)</title>
    <style type="text/css">
        body {
    ...
    <table style="width:80%;" id="hh">
        <?php foreach ($detail as $key) { ?>
            ...
            <tr>
                ...
                <td class="syarat">Hablur, kecil, berwarna putih atau kuning muda, agak berbau khas.</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Kelarutan dalam air</td>
                <td class="hsl"><?= $key['kel_air'] ?></td>
                <td class="syarat">Mudah larut dan membentuk larutan opalesen</td>
            </tr>
            <tr>
                <td rowspan="2" class="hsl"><?= $no++ ?></td>
                <td rowspan="2" class="namapmr">Identifikasi Sodium Sulfat</td>
                <td class="hsl"><?= $key['identifikasi_ss'] ?></td>
                <td class="syarat">Terbentuk endapan putih Barium Klorida</td>
            </tr>
            <tr>
                <td class="hsl"><?= $key['identifikasi_ss'] ?></td>
                <td class="syarat">Tidak Terbentuk endapan dalam Asam Klorida</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Kadar</td>
                <td class="hsl"><?= $key['kadar'] ?></td>
                <td class="syarat">Kurang dari 99%</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
