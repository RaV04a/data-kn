...
<head>
    ...
    <title>Hasil Data Pemeriksaan Bahan Tambahan (Lecithin Adlec)</title>
    <style type="text/css">
        body {
    ...
    <table style="width:80%;" id="hh">
        <?php foreach ($detail as $key) { ?>
            <tr>
                ...
                <td class="jdl" style="width: 30%;">Jenis Pemeriksaan</td>
            ...
            <tr>
                ...
                <td class="syarat">Zat padat yang plastis hingga cairan, warna kuning muda hingga cokelat.Tidak berbau atau berbau khas agak mirip pala, rasa lemah.</td>
            </tr>
            <tr>
                <td rowspan="3" class="hsl"><?= $no++ ?></td>
                <td rowspan="3" class="namapmr">Kelarutan</td>
                <td class="hsl"><?= $key['kelarutan'] ?></td>
                <td class="syarat">- Larut sebagian dalam air, segera membentuk hidrat menjadi emulsi</td>
            </tr>
            <tr>
                <td class="hsl"><?= $key['kelarutan'] ?></td>
                <td class="syarat">- Larut sebagian dalam etanol P</td>
            </tr>
            <tr>
                <td class="hsl"><?= $key['kelarutan'] ?></td>
                <td class="syarat">- Tidak larut dalam aceton P</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Viscosity</td>
                <td class="hsl"><?= $key['viscosity'] ?></td>
                <td class="syarat">Maksimal 6000 cPs</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Identifikasi :<br> 1 gr zat + 2 gr Na2CO3 P <br> pijarkan + 5 mL air + 5 mL <br> HN03 P + 5 mL Ammonium <br> molibdat LP panaskan hingga mendidih</td>
                <td class="hsl"><?= $key['identifikasi'] ?></td>
                <td class="namapmr">Terbentuk endapan kuning</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
                <td class="namapmr">Angka Lempeng Total</td>
                <td class="hsl"><?= $key['ang_lempeng_tot'] ?></td>
                <td class="syarat">≤1000 cfu/gr</td>
            </tr>
            <tr>
                <td class="hsl"><?= $no++ ?></td>
