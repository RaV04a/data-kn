...
<head>
    ...
    <title>History Mesin CWP & HWP</title>
    <style type="text/css">
        body {
...
<body>
    ...
    <div style="text-align: center;padding-top: 5px;">
        <h3 style="float: center;line-height: 0.2;">HISTORY MESIN CWP & HWP</h3>
        <h5 style="line-height: 0.1px;">(Chiler Water Pump & Hot Water Pump)</h5>
