...
class M_frm_rks_stabilitas extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_frm WHERE jenis_doc_frm IN ('Rks Stabilitas')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('RKS Stabilitas','$data[nama_doc_frm]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
