...
class M_frm_kualifikasi extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_frm WHERE jenis_doc_frm IN ('Kualifikasi')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('kualifikasi','$data[nama_doc_frm]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
