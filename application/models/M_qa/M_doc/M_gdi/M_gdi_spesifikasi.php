...
class M_gdi_spesifikasi extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_gdi WHERE jenis_doc_gdi IN ('Spesifikasi')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('Spesifikasi','$data[nama_doc_gdi]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
