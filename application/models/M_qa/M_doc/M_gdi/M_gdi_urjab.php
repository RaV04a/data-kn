...
class M_gdi_urjab extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_gdi WHERE jenis_doc_gdi IN ('Urjab')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('Urjab','$data[nama_doc_gdi]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
