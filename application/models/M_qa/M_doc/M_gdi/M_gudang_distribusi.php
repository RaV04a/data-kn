...
class M_gudang_distribusi extends CI_Model
{
    ...
    public function add($data)
    {
        ...
        VALUES ('$data[jenis_doc_gdi]','$data[nama_doc_gdi]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
