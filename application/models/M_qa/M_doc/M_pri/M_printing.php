...
class M_printing extends CI_Model
{
    ...
    public function add($data)
    {
        ...
        VALUES ('$data[jenis_doc_pri]','$data[nama_doc_pri]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
