...
class M_pri_kualifikasi extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_pri WHERE jenis_doc_pri IN ('Kualifikasi')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('Kualifikasi','$data[nama_doc_pri]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
