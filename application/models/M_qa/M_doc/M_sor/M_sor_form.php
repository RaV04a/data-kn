...
class M_sor_form extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_sor WHERE jenis_doc_sor IN ('Form')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('Form','$data[nama_doc_sor]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
