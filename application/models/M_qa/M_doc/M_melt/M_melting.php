...
class M_melting extends CI_Model
{
    ...
    public function add($data)
    {
        ...
        VALUES ('$data[jenis_doc_melt]','$data[nama_doc_melt]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
