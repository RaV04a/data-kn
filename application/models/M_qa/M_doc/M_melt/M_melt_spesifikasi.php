...
class M_melt_spesifikasi extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_melt WHERE jenis_doc_melt IN ('Spesifikasi')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('Spesifikasi','$data[nama_doc_melt]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
