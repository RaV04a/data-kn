...
class M_pac_urjab extends CI_Model
{
    ...
    {
        $sql = "
        SELECT * FROM tb_doc_pac WHERE jenis_doc_pac IN ('Urjab')
        ";
    ...
    public function add($data)
    {
        ...
        VALUES ('Urjab','$data[nama_doc_pac]','$data[tgl_berlaku]','$data[tgl_review]','NOW()','$id_user','0000-00-00 00:00:00','$id_user','0')
        ";
